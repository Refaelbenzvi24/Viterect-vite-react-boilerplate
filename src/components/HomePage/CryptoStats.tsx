...
interface CryptoStatsProps { stats: CoinStats | undefined }

export default function ({ stats }: CryptoStatsProps) {
...
interface NumberTooltipProps { number: number }

function NumberTooltip({ number }: NumberTooltipProps): JSX.Element {
	const dir = i18n.dir();
