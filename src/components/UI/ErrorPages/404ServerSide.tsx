...
export default () => {
    const [cordContext, setCordContext]   = useState<CanvasRenderingContext2D>()
            ...
            <div className="error-404-ss">
                ...
                <div className="astronaut">
                    ...
                    <div className="astronaut__head">
                        <canvas id="visor" ref={(c) => setVisorContext(c?.getContext('2d') as CanvasRenderingContext2D)}
                                width="60px"
                                height="60px"/>
