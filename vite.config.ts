...
// TODO: generate favicons and change the code below
    ...
    plugins: [
        ...
        Pages({
            ...
            extendRoute(route, parent) {
                ...
                //TODO: check if I can add some code here to make the routing go deeper than 3 dirs.
                if (route.path === "/") {
        ...
        Markdown({
            ...
            headEnabled: true,
            // TODO: find what is needed to fix this
            // markdownItSetup(md) {
            //     // https://prismjs.com/
            //     md.use(Prism)
